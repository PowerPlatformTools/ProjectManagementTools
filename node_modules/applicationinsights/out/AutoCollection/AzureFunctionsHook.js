...
var AzureFunctionsHook = /** @class */ (function () {
        ...
        if (!this._preInvocationHook) {
            this._preInvocationHook = this._functionsCoreModule.registerHook("preInvocation", function (preInvocationContext) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    preInvocationContext.functionCallback = function (ctx, request) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
    ...
    AzureFunctionsHook.prototype._propagateContext = function (ctx, request, originalCallback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    extractedContext = CorrelationContextManager_1.CorrelationContextManager.startOperation(ctx, request);
                ...
                CorrelationContextManager_1.CorrelationContextManager.wrapCallback(function () { return __awaiter(_this, void 0, void 0, function () {
                    var startTime, statusCode;
                    var _a;
    ...
    AzureFunctionsHook.prototype._removePreInvocationHook = function () {
        if (this._preInvocationHook) {
