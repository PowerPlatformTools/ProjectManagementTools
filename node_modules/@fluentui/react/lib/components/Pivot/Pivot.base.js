...
export var PivotBase = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("div", __assign({ role: "toolbar" }, divProps, { ref: ref }),
        React.createElement(FocusZone, __assign({ componentRef: focusZoneRef, role: "tablist", direction: FocusZoneDirection.horizontal }, focusZoneProps, { className: css(classNames.root, focusZoneProps === null || focusZoneProps === void 0 ? void 0 : focusZoneProps.className) }),
            items,
