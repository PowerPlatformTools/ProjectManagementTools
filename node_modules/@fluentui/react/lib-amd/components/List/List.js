define(["require", "exports", "tslib", "react", "../../Utilities", "./List.types", "../../Utilities"], function (require, exports, tslib_1, React, Utilities_1, List_types_1, Utilities_2) {
    "use strict";
    ...
    var List = /** @class */ (function (_super) {
        ...
        function List(props) {
            ...
            _this._onRenderPage = function (pageProps, defaultRender) {
                ...
                var _b = pageProps.page, _c = _b.items, items = _c === void 0 ? [] : _c, startIndex = _b.startIndex, divProps = tslib_1.__rest(pageProps, ["page"]);
        ...
        List.prototype.render = function () {
            ...
            var finalOnRenderSurface = onRenderSurface
                ? Utilities_2.composeRenderFunction(onRenderSurface, this._onRenderSurface)
            ...
            return finalOnRenderRoot({
                ...
                divProps: tslib_1.__assign(tslib_1.__assign({}, divProps), { className: Utilities_1.css('ms-List', className), role: pageElements.length > 0 ? role : undefined }),
            });
        };
        ...
        List.prototype._updatePages = function (nextProps, previousState) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, previousState), newListState);
        };
        /**
        ...
        List.prototype._buildPages = function (props, state) {
            ...
            var _loop_1 = function (itemIndex) {
                ...
                var isPageRendered = Utilities_1.findIndex(state.pages, function (page) { return !!page.items && page.startIndex === itemIndex; }) > -1;
