define(["require", "exports", "tslib", "../../Utilities", "../../Positioning", "../../Styling"], function (require, exports, tslib_1, Utilities_1, Positioning_1, Styling_1) {
    "use strict";
    var _a, _b, _c;
        ...
        return {
            ...
            dropdownItemHeader: [
                ...
                tslib_1.__assign(tslib_1.__assign({}, fonts.medium), { fontWeight: Styling_1.FontWeights.semibold, color: semanticColors.menuHeader, background: 'none', backgroundColor: 'transparent', border: 'none', height: DROPDOWN_ITEM_HEIGHT, lineHeight: DROPDOWN_ITEM_HEIGHT, cursor: 'default', padding: '0 8px', userSelect: 'none', textAlign: 'left', selectors: (_k = {},
                        _k[Styling_1.HighContrastSelector] = tslib_1.__assign({ color: 'GrayText' }, Styling_1.getHighContrastNoAdjustStyle()),
                        _k) }),
            ],
            subComponentStyles: {
