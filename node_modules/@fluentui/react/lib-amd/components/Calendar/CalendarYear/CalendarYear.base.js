define(["require", "exports", "tslib", "react", "../../../Utilities", "../../../FocusZone", "../../../Icon", "@fluentui/react-hooks", "../defaults"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Icon_1, react_hooks_1, defaults_1) {
    "use strict";
    ...
    var CalendarYearGridCell = function (props) {
        ...
        return (React.createElement("button", { className: Utilities_1.css(classNames.itemButton, (_a = {},
                ...
                _a)), type: "button", role: "gridcell", onClick: !disabled ? onClick : undefined, onKeyDown: !disabled ? onKeyDown : undefined, disabled: disabled, "aria-selected": selected, ref: buttonRef, "aria-readonly": true }, (_b = onRenderYear === null || onRenderYear === void 0 ? void 0 : onRenderYear(year)) !== null && _b !== void 0 ? _b : year));
    };
