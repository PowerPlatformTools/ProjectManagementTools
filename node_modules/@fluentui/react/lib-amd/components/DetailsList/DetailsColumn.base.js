define(["require", "exports", "tslib", "react", "../../Icon", "../../Utilities", "./DetailsList.types", "./DetailsRow.styles"], function (require, exports, tslib_1, React, Icon_1, Utilities_1, DetailsList_types_1, DetailsRow_styles_1) {
    ...
    var DetailsColumnBase = /** @class */ (function (_super) {
        ...
        DetailsColumnBase.prototype.render = function () {
            var _a = this.props, column = _a.column, columnIndex = _a.columnIndex, parentId = _a.parentId, isDraggable = _a.isDraggable, styles = _a.styles, theme = _a.theme, _b = _a.cellStyleProps, cellStyleProps = _b === void 0 ? DetailsRow_styles_1.DEFAULT_CELL_STYLE_PROPS : _b, _c = _a.useFastIcons, useFastIcons = _c === void 0 ? true : _c;
