define(["require", "exports", "tslib", "react", "../../Utilities", "./ResizeGroup.types", "@fluentui/react-hooks", "../../WindowProvider"], function (require, exports, tslib_1, React, Utilities_1, ResizeGroup_types_1, react_hooks_1, WindowProvider_1) {
    "use strict";
    ...
    function useResizeState(props, nextResizeGroupStateProvider, rootRef) {
        var initialStateData = react_hooks_1.useConst(function () { return nextResizeGroupStateProvider.getInitialResizeGroupState(props.data); });
    ...
    function useResizingBehavior(props, rootRef) {
        var nextResizeGroupStateProvider = react_hooks_1.useConst(exports.getNextResizeGroupStateProvider);
        ...
        react_hooks_1.useOnEvent(win, 'resize', async.debounce(remeasure, RESIZE_DELAY, { leading: true }));
    ...
    exports.ResizeGroupBase = React.forwardRef(function (props, forwardedRef) {
        ...
        var divProps = Utilities_1.getNativeProps(props, Utilities_1.divProperties, ['data']);
