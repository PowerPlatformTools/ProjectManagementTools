...
var ComboBoxInternal = /** @class */ (function (_super) {
    ...
    function ComboBoxInternal(props) {
        ...
        _this._onRenderList = function (props) {
            ...
            var id = _this._id;
            return (React.createElement("div", { id: id + '-list', className: _this._classNames.optionsContainer, "aria-labelledby": label && id + '-label', "aria-label": ariaLabel && !label ? ariaLabel : undefined, role: "listbox" }, options.map(function (item) { return onRenderItem === null || onRenderItem === void 0 ? void 0 : onRenderItem(item, _this._onRenderItem); })));
        };
        // Render items
    ...
    ComboBoxInternal.prototype._getCurrentOptionStyles = function (item) {
        ...
        return ComboBox_styles_1.getOptionStyles(this.props.theme, customStylesForAllOptions, customStylesForCurrentOption, this._isPendingOption(item), item.hidden, this._isOptionSelected(item.index));
    };
    /**
