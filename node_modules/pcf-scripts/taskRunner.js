...
class TaskRunner {
    ...
    run(taskGroup) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logMessage(`${(0, locale_2.translate)(diagnosticMessages_generated_1.strings.initializing.key)}...`);
            ...
            for (let i = 0; i < Object.keys(tsg).length; i++) {
                ...
                try {
                    ...
                    this.logError(`${(0, locale_2.translate)(diagnosticMessages_generated_1.strings.failed.key)}:`);
                    this._diagnostics.flush(this._colorize);
                    return;
                }
            }
            this.logMessage(`${(0, locale_2.translate)(diagnosticMessages_generated_1.strings.succeeded.key)}`);
            this._diagnostics.flush(this._colorize);
            return taskResult;
        });
    }
    ...
    setLocale() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield (0, locale_1.configureLocale)({
